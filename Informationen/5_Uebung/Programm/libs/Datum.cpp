 ...
 */
/**
 * Standardkonstruktor zur Initialisierung eines sinnvollen Datums
 */
#include "Datum.h"
Datum::Datum(){
	tag = 1;
...
/**
 * Setzt den Monat.
 * @param der_monat Monat, der gesetzt werden soll.
 */
...
/**
 * Setzt das Jahr.
 * @param das_jahr Jahr, das gesetzt werden soll.
 */
