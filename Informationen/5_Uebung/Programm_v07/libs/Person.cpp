 ...
 */
bool cmp_person_nachname_vorname_geb(Person *p1, Person *p2) {
...
/*
nach dem Geburtsdatum, bei gleichem Geburtsdatum nach dem Nachnamen, bei gleichem
Nachnamen nach dem Vornamen;
*/
bool cmp_person_gebjahr_nachname_vorname(Person *p1, Person *p2) {
	bool is_richtig = false;
...
bool cmp_person_geb_nachname_vorname(Person *p1, Person *p2) {
	bool is_richtig = false;
    if(p1->get_gebdat().get_datum() < p2->get_gebdat().get_datum()){
    	is_richtig = true;
    }else if (p1->get_gebdat().get_datum() > p2->get_gebdat().get_datum()){
